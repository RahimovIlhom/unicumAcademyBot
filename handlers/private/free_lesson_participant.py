...
@dp.message(StateFilter(None), PrivateFilter(), F.text == "✅ Ha, bepul ochiq darsga qatnashib ko'raman")
...
@dp.message(StateFilter(None), PrivateFilter(), F.text == "❌ Yo'q, hozircha kerak emas")
